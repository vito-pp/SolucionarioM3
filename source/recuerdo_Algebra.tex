\begin{definition}[Espacio Vectorial]
    ...
    \end{equation*}
\end{definition}
\begin{definition}[Transformación Lineal]
...
\begin{definition}[Ecuación de la recta en el espacio]
...
\end{definition}
\begin{definition}[Ecuación del plano]
...
\end{definition}
\begin{definition}[Ecuación de la circunferencia]
...
\end{definition}
\begin{definition}[Ecuación del círculo]
...
\end{definition}
\begin{definition}[Ecuación de la esfera]
