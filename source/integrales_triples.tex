...
\begin{definition}
    ...
    \begin{enumerate}
        ...
        \item[iii.]
        Decimos que la regi\'on $U$ es de \textit{tipo} \rom{3} si se puede expresar en la forma de \eqref{eq:tipo i} o \eqref{eq:tipo ii}, intercambiados los papeles de $y$ y $z$.\final
        \end{enumerate}
\end{definition}
