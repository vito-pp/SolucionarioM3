...
\begin{solution}
    ...
    \]
    pues $(x_0, y_0, z_0)$ pertenece al primer octante. Por lo que queda demostrado que el flujo es positivo. % por que seria -no negativo-? cuando R=0 o cuando el centro de la esfera es el origen?
\end{solution}
