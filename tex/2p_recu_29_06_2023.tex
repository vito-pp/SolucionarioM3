...
\begin{solution}
  \textcolor{red}{rehacer}   Dado que la curva $C$ es simple cerrada y existe una parametrizaci\'on de int$(C)$, y $\nabla \times F=0$, la integral es 0 para cualquier orientaci\'on.
\end{solution}
...
\begin{solution}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot3[fill=red!50, opacity=0.8, draw=none] coordinates {(0,0,0) (0,2,0) (2,2,0) (2,0,0) (0,0,0)};
        \addplot3[fill=green!50, opacity=0.8, draw=none] coordinates {(0,0,0) (0,0,2) (2,0,2) (2,0,0) (0,0,0)};
        \addplot3[fill=blue!50, opacity=0.8, draw=none] coordinates {(0,0,0) (0,2,0) (0,2,2) (0,0,2) (0,0,0)};
        \addplot3[fill=yellow!50, opacity=0.8, draw=none] coordinates {(2,0,0) (2,2,0) (2,2,2) (2,0,2) (2,0,0)};
