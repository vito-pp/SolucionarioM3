...
\section{Nociones de Topolog�a.} \label{sec:topo}
 ...
 Sean $x_o \in \Re^n, \delta > 0$ y $\dis$ una distancia en $\Re^n$. La \emph{bola de radio $\delta$ y centro $x_o$}, que denotamos con $B_{\delta}(x_o)$, es el conjunto:
 \[
  B_{\delta}(x_o) = \left\lbrace x \in \Re^n : \dis(x,x_o) < \delta \right\rbrace.
 \]
 El conjunto
 \[
...
\begin{definition} [Punto de acumulaci�n] \label{def:pto_acum}
 Sean $A \subset \Re^n \text{ y } x_o \in \Re^n$. Decimos que $x_o$ es \emph{punto de acumulaci�n} de $A$ si
 \[
  \forall \delta > 0 \left( B_{\delta}(x_o) - \{ x_o \} \right) \cap A \ne \emptyset. 
 \]
 Denotamos el conjunto de todos los puntos de acumulaci�n de $A$ con $A'$:
 \[
  A' = \{ x \in \Re^n : x \text{ es punto de acumulaci�n de } A \}.
 \]
...
\begin{definition} [Punto aislado] \label{def:pto_ais}
 Sean $A \subset  \Re^n$ y $x_o \in A$. Decimos que $x_o$ es \emph{punto aislado} de $A$ si $x_o$ no es punto de acumulaci�n de $A$.
\end{definition}
...
Sean $f:A \subset \Re^n \to \Rn{m}$ una funci�n, $L \in \Rn{m}$ y $x_0$ un punto de acumulaci�n de $A$. Decimos que \emph{el l�mite de $f$ para $x$ tendiendo a $x_o$ es $L$} o que \emph{$f$ tiende a $L$ cuando $x$ tiende a $x_o$}
si
\[
...
\begin{itemize} 
 \item Sean $f:A \subset \Re^n \to \Rn{m}$ una funci�n, $L \in \Rn{m}$ y $x_0$ un punto de acumulaci�n de $A$. Decimos que \emph{el l�mite de $f$ para $x$ tendiendo a $x_o$ es $L$} o que \emph{$f$ tiende a $L$ cuando $x$ tiende a $x_o$} si
\[
...
\begin{theorem}[Unicidad del l�mite] \label{teo:unicidad_limite}
\mbox{}

Sean $f:A \subset \Re^n \to \Rn{m}$ una funci�n, $x_0$ un punto de acumulaci�n de $A$ y $L_1, L_2 \in \Rn{m}$ tales que 
\[
...
\end{theorem}
\begin{propiedad}[�lgebra de l�mites] \label{prop:alg_lim} Sean $f,g:A \subset \Re^n \to \Rn{m}$ funciones y $x_0$ un punto de acumulaci�n de $A$. Supongamos que 
  \begin{align*}
...
\begin{propiedad} \label{prop:lim_x_comp}
 Sea $F: A \subset \Re^n \to \Rn{m}$ un campo vectorial y $x_0$ un punto de acumulaci�n de $A$. Sean $f_j: A \subset \Re^n \to \R \, (j = 1,2, \dots, m)$ campos escalares tales que $F(x) = \left( f_1(x), f_2(x), \dots, f_m(x) \right) \, \forall x \in A$\footnote{Los campos escalares $f_j$ quedan determinados un�vocamente por $F$ de la siguiente manera: 
 \begin{align*}
...
\end{propiedad}
  ...
  \begin{propiedad} \label{prop:lim_1}
    Sean $f:A \subset \Re^n \to \R$ una funci�n y $x_0$ un punto de acumulaci�n de $A$. Las siguientes proposiciones son equivalentes:
 \begin{enumerate} [i.]
...
Sean $f, g, h : A \subset \Re^n \to \R$ funciones y $x_0$ un punto de acumulaci�n de $A$. Supongamos que $\exists \delta_o > 0$ tal que 
\[
...
\begin{propiedad} \label{prop:cero_x_acotada}
 Sean $f, g : A \subset \Re^n \to \R$ funciones y $x_0$ un punto de acumulaci�n de $A$. Si $\exists \delta_o > 0$ tal que $f$ es acotada en $B_{\delta_o}(x_o) \cap A$ (i.e.: $\exists M > 0 \text{ tal que } \abs{f(x)} \le M \forall x \in  B_{\delta_o}(x_o) \cap A$) y $\lim_{x \to x_o}g(x) = 0$, entonces
\[
...
\begin{propiedad}[L�mites por conjuntos] \label{prop:lim_x_conj}
   Sea $f : A \subset \Re^n \to \Rn{m}$ una funci�n, con $A = A_1 \cup A_2$.\\
...
\begin{definition}[L�mite infinito] \label{def:lim_inf}
  Sean $f : A \subset \Re^n \to \R$ una funci�n y $x_0$ un punto de acumulaci�n de $A$. 
  \begin{enumerate} [I.]
...
\begin{definition}[L�mite en el infinito] \label{def:lim_x_inf}
Sean $f : \Re^n \to \R$ una funci�n y $L \in \R$. Decimos que
...
\mbox{}
Sean $f: A \subset \Re^n \to \R$ y $x_o \in \interior{(A)}$. Decimos que $f$ es \emph{diferenciable en $x_o$} si $\exists m \in \Re^n$ tal que
\[
...
Sean $f: A \subset \Re^n \to \Rn{m}$ y $x_o \in \interior{(A)}$. Decimos que $f$ es \emph{diferenciable en $x_o$} si $\exists M \in \Rnp{m}{n}$ tal que
\[
...
Sean $f: A \subset \Re^n \to \R$ y $x_o \in \interior{(A)}$. Si $f$ es diferenciable en $x_o$, entonces $f$ es continua en $x_o$.
 \begin{proof}
 \mbox{}
 
 Como $f$ es diferenciable en $x_o, \exists m \in \Re^n$ tal que
 \[
  \lim_{x \to x_o} \frac{f(x) - f(x_o) - m \cdot (x - x_o)}{\norm{x - x_o}} = 0.
 \]
...
\]
\fi
Sean $f: A \subset \Re^n \to \R$ y $x_o \in \interior{(A)}$, tales que $\exists m = (m_1, m_2, \cdots, m_n) \in \Re^n \, /$
\[
 \lim_{x \to x_o} \frac{f(x) - f(x_o) - m \cdot (x - x_o)}
                                 {\norm{x - x_o}} = 0
\]
...
\begin{corolario}
 Sean $f: A \subset \Re^n \to \R$ y $x_o \in \interior{(A)}$. Son equivalentes:
 \begin{enumerate} [I.]
...
Sea $f: A \subset \Re^n \to \R$ diferenciable en $x_o \in \interior{(A)}$. Entonces, $\forall \check{u} \in \Re^n \text{tal que } \norm{\check{u}} = 1$ existe en $x_o$ la derivada de $f$ en la direcci�n de $\check{u}$ y, adem�s,
\[
...
\mbox{}
 ...
 Sean $f: A \subset \Re^n \to \R$ diferenciable en un punto $x_o \in \interior{(A)}$. Entonces 
 \[
...
\mbox{}
 ...
 Como $f$ es diferenciable en $x_o$, por el teorema \eqref{teo:difDir}, $\forall \check{u} \in \Re^n \text{tal que } \norm{\check{u}} = 1$ existe en $x_o$ la derivada de $f$ en la direcci�n de $\check{u}$ y, adem�s,
\[
 \frac{\partial f}{\partial \check{u}} (x_o) = \grad f (x_o) \cdot \check{u}.
\]
...
\begin{theorem}[Teorema de la Funci�n Inversa] \label{teo:inversa}
\mbox{}

 Sean $A \subset \Re^n$ un conjunto abierto y $F: A \subset \Re^n \to \Re^n$ una funci�n de clase $\mathcal{C}^1$. Sea $x_o \in A$ y supongamos que $\det(\mathbf{D}F_{(x_o)}) \ne 0$. Entonces existen un entorno abierto $U \subset A$ de $x_o$ y un entorno abierto $V \subset \Re^n$ de $F(x_o)$ tal que $F:U \to V$ (la restricci�n de $F$ a $U$) tiene inversa $F^{-1}:V \to U$. Esta funci�n $F^{-1}$ es de clase $\mathcal{C}^1$ y, adem�s,
 \[
...
\begin{theorem}[Caso particular del Teorema de la Funci�n Impl�cita] \label{teo:implicit_part}
\mbox{}
...
\begin{theorem}[Teorema de la Funci�n Impl�cita] \label{teo:implicit}
\mbox{}

 Sean $A \subset \Re^n \times \Rn{m}$ un conjunto abierto y $F: A \to \Rn{m}$ una funci�n de clase $\mathcal{C}^1$. Sea $(x_o,z_o) \in A$ tal que $F(x_o,z_o) = \mathbf{0}$. Formemos el determinante
 \[
...
\begin{theorem}[Condici�n necesaria de extremo] \label{teo:grad_nulo}
 Sea $f: A \subset \Re^n \to \R$ diferenciable en alg�n entorno abierto de $x_o \in \interior{(A)}$. Supongamos que $f$ tiene un extremo en $x_o$. Entonces
 \[
  \grad f(x_o) = \mathbf{0}.
 \]
\end{theorem}
...
\begin{definition} [Punto cr�tico] \label{def:pto_crit}
 Sean $f: A \subset \Re^n \to \R$ y $x_o \in \interior{(A)}$. Decimos que $x_o$ es un \emph{punto cr�tico} de $f$ si $f$ no es diferenciable en $x_o$ o $\grad f_{(x_o)} = \mathbf{0}$.
\end{definition}

\begin{definition} [Punto silla] \label{def:pto_silla}
 Sean $f: A \subset \Re^n \to \R$ y $x_o \in \interior{(A)}$. Si $x_o$ es un punto cr�tico de $f$ y $f$ no tiene un extremo en $x_o$, decimos que $f$ tiene un \emph{punto silla} en $x_o$.
\end{definition}
...
\begin{theorem}[de los valores extremos de Weierstrass] \label{teo:weier}difDir
  Sean $A \subset \Re^n$ un conjunto cerrado y acotado y $f: A \subset \Re^n \to \R$ una funci�n continua. Entonces $f$ alcanza un m�ximo y un m�nimo absoluto en $A$.
\end{theorem}
